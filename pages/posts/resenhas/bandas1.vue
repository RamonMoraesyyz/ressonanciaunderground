<template>
    <div class="container mx-auto pt-24 sm:pt-24 pb-10 px-4 sm:px-6 lg:px-8"> <!-- Ajuste de padding para telas menores -->
      ...
      <article class="max-w-3xl mx-auto bg-black text-white shadow-md rounded-lg p-6 sm:p-8">
        <!-- Título do post -->
        <h1 class="text-3xl sm:text-4xl flex justify-center font-bold p-16 sm:p-12">Bandas difíceis de se classificar</h1> <!-- Ajuste de tamanho do texto para responsividade -->
  
        <!-- Data e autor -->
        <p class="text-sm text-gray-500 mb-2">Publicado em 01 de Setembro de 2024 por Ramon Moraes</p>
        ...
        <div class="space-y-6">
            ...
            <div class="mb-6">
          <img src="/public/resenhas/sleep.jpg" alt="Sleep" class="w-full h-auto rounded-lg">
            </div>
          ...
          <div>
            <p class="text-xl font-bold mb-3">Zeal & Ardor</p>
            <p class="text-white text-base mb-1">Um som que se destaca pela sua fusão única de black metal com elementos de spirituais negros, blues e música eletrônica, criando um som que é ao mesmo tempo inovador e carregado de profundidade emocional. Formada pelo músico suíço-americano Manuel Gagneux, a banda nasceu de um experimento provocativo em que Gagneux mesclou o peso sombrio do metal extremo com os cânticos espirituais de escravos afro-americanos.
          ...
          <div>
            <p class="text-xl font-bold mb-3">Sleep Token</p>
            <p class="text-white text-base mb-1"> É uma banda que mergulha seus ouvintes em um universo sonoro envolvente e enigmático, onde a espiritualidade e o metal alternativo se encontram. Liderada por uma figura misteriosa conhecida apenas como "Vessel," a banda mantém uma aura de mistério que amplifica o impacto de sua música. Sleep Token combina elementos de metal progressivo, ambient, e R&B em composições que são ao mesmo tempo intensas e etéreas.
            O som da banda é marcado por vocais emotivos, arranjos dinâmicos e uma produção que alterna entre momentos de fragilidade e explosões de poder. Faixas como "The Offering" e "The Night Does Not Belong to God" exemplificam essa dualidade, com letras introspectivas e atmosferas sonoras que evocam uma sensação de ritual quase sagrado. Cada álbum de Sleep Token parece narrar uma jornada espiritual, onde temas de devoção, paixão e transcendência são explorados com uma profundidade rara no cenário musical atual.
